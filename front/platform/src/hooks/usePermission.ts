...
import { useIsAuthorizedForCase } from '@/api/authority-api/authority-api'
import type { PermissionCheckOptions, PermissionResult } from '@/constants/auth/auth'
import type { UserRole } from '@/constants/auth/permissions'
import { DEFAULT_ROUTE, MENU_PERMISSIONS, USER_ROLES } from '@/constants/auth/permissions'
