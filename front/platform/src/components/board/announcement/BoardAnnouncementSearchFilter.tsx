...
interface BoardAnnouncementSearchFilterProps {
  onSubmit: SubmitHandler<GetBoardAnnouncementListParams>
}
const BoardAnnouncementSearchFilter: React.FC<BoardAnnouncementSearchFilterProps> = ({
  onSubmit,
}) => {
  const { handleSubmit, register, control, reset } = useForm<GetBoardAnnouncementListParams>({
    defaultValues: {
...
export default BoardAnnouncementSearchFilter
