...
import type { GetConclusionOpinionListParams, GetPrecedentListParams } from '@/model'

interface ReferencePrecedentSearchFilterProps {
  onSubmit: SubmitHandler<GetPrecedentListParams>
  classNameOfOpinionTemplateSelectBox?: string
}

const ReferencePrecedentSearchFilter: React.FC<ReferencePrecedentSearchFilterProps> = ({
  onSubmit,
  classNameOfOpinionTemplateSelectBox,
}) => {
...
export default ReferencePrecedentSearchFilter
